...
to_lang = input("Enter the code of the preferred language to be translated into: ")

# capture voice
with micro as source:
    print("Speak 'hello' out loud to initiate the translation!")
    print("-------------------->")
...
if 'hello' in recog1.recognize_google(audio):
    ...
    with micro as source:
        ...
        try:
            ...
            default_text = (translator.translate(get_sentence, src = 'en', dest = from_lang)).text
